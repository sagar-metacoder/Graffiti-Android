...
import com.app.graffiti.salesperson.activity.AddDealerActivity
...
/**
 * [DistributorDealerListActivity] : <p>
 *
 * </p>
...
class DistributorDealerListActivity : BaseActivity(),
        NetworkCallBack<Response<ResponseBody>> {
    companion object {
        val TAG = DistributorDealerListActivity::class.java.simpleName
                ?: "DistributorDealerListActivity"
    }

    private val fragmentAdapter: FragmentAdapter by lazy {
        val fragmentList = ArrayList<FragmentAdapter.FragmentHolder>()
        fragmentList.add(FragmentAdapter.FragmentHolder("Active", DealerListFragment.newInstance(userId)))
        fragmentList.add(FragmentAdapter.FragmentHolder("Pending", DealerListFragment.newInstance(userId)))
        FragmentAdapter(supportFragmentManager, fragmentList)
    }
    private val dealerListCall by lazy {
        return@lazy Network.Builder(this, dealersOfDistributor)
    ...
    private lateinit var dealersOfDistributor: WebServiceProvider.DealersOfDistributor
    ...
    private fun getDealerList() {
        dealersOfDistributor = WebServiceProvider.DealersOfDistributor(
                userId,
