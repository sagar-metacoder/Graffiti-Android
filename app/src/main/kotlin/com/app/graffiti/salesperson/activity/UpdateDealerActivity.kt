...
class UpdateDealerActivity : BaseActivity(), NetworkCallBack<Response<ResponseBody>> {
    companion object {
        val TAG = UpdateDealerActivity::class.java.simpleName
    }
    ...
    private lateinit var updateDealerCall: Network
    private lateinit var updateDealer: WebServiceProvider.UpdateDealer
    private lateinit var deleteDealerCall: Network
    private lateinit var deleteDealer: WebServiceProvider.DeleteDealer
    ...
    override fun onBaseCreated(savedInstanceState: Bundle?) {
        setUpToolbar("Update Dealer", true)
        setUpData(user)
    ...
    private fun isValidAll(): Boolean {
        ...
        return !Validations.isEmpty(activity_update_distributor_dealer_textInput_firstName, "First name can't be empty")
                ...
                && !Validations.isEmpty(activity_update_distributor_dealer_textInput_address, "Address can't be empty")
    }
    ...
    private fun updateUser() {
        ...
        updateDealer = WebServiceProvider.UpdateDealer(updateData)
        updateDealerCall = Network.Builder(this, updateDealer)
                .setFileExtension(".json")
                .build()
        updateDealerCall.call(this)
    }
    ...
    private fun deleteUser() {
        deleteDealer = WebServiceProvider.DeleteDealer(user?.id ?: -1)
        deleteDealerCall = Network.Builder(this, deleteDealer)
                .setFileExtension(".json")
                .build()
        deleteDealerCall.call(this)
    }
